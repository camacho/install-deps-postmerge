...
| -------------- | --------------- | ----------- | -------- |
 ...
 | [yarn-or-npm@^2.0.4](https///github.com:camacho/yarn-or-npm) | Use Yarn or npm to execute a command | 2.0.4 | production | 
<!-- AUTO-GENERATED-CONTENT:END -->
...
| -------------- | --------------- | ----------- | -------- |
 ...
 | [markdown-magic-install-command@^1.3.1](https://github.com/camacho/markdown-magic-install-command#readme) | Print install command for markdown file | 1.3.1 | dev | 
